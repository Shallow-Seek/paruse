...
#### Paruse uses [paru](https://github.com/Morganamilo/paru) & [fzf](https://github.com/junegunn/fzf) to present & manage *goto* task centered around packages.
- You can browse Arch Repos in real-time, filtering through packages <ins>**while you type**</ins> (not, after pressing `Enter`)
- You can manage install/uninstall/purge, single packages or bulk/batch packages
- You can backup/restore packagelist, update system, clean cache, view arch news, and a couple of other things
